...
public class BootIocProj06MiniProjectRealtimeDiApplication {
	...
	public static void main(String[] args) {
		...
		try (ConfigurableApplicationContext ctx = SpringApplication
				.run(BootIocProj06MiniProjectRealtimeDiApplication.class, args); Scanner sc = new Scanner(System.in);) {
